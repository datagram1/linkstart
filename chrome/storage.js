/**
 * Storage functions for Chrome service worker
 * Loaded via importScripts() in background.js
 */

// Storage functions for managing groups, sites, and settings
// Uses browser.storage API (works in both Chrome and Firefox)
